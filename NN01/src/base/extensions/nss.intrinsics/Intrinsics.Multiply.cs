...
namespace NSS
{
    static public partial class Intrinsics
    {
        ...
        public static Span<float> Multiply(Span<float> a, Span<float> b)
        {
        ...
        /// output = a * b  
        /// </summary>
        public static Span<float> Multiply(Span<float> a, Span<float> b, Span<float> output)
        {
            int i = 0; 
            ...
            if(Avx.IsSupported)
            {
                if (a.Length > 7)
                {
                    ...
                    unchecked
                    {
                        ...
                        while (i < (a.Length & ~31))
                        {
                            d[j + 0] = Avx.Multiply(aa[j + 0], bb[j + 0]);
                            d[j + 1] = Avx.Multiply(aa[j + 1], bb[j + 1]);
                            d[j + 2] = Avx.Multiply(aa[j + 2], bb[j + 2]);
                            d[j + 3] = Avx.Multiply(aa[j + 3], bb[j + 3]);
                            i += 32;
                            j += 4;
                        }
                        while (i < (a.Length & ~7))
                        {
                            d[j] = Avx.Multiply(aa[j], bb[j]);
                            i += 8;
                            j++;
                        }
                    }
