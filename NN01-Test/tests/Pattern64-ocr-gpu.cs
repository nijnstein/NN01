...
namespace UnitTests
{
    public class Pattern64_ocr_gpu
    {
        int patternSize = 64;
...
"01111110"
        ...
        public void Run(int steps = 20, bool enableGPU = false)
        {
            ...
            if(settings.GPU)
            {
            Console.WriteLine($">        Accelerator: {accelerator.Device.Name} {accelerator.Device.MemorySize / 1024 / 1024}MB");
